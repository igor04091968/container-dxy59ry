...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dxy59ry.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dxy59ry.containers.anotherwebservice.com/
...
```
git clone git@github.com:igor04091968/container-dxy59ry.git
cd container-dxy59ry
```
...
```
docker attach container-dxy59ry
```
